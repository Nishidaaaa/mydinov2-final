...
def eval_knn_with_model(
    ...
    #print('train_dataset_str')#ImageNet:split=TRAIN:root=/a/n-nishida/mydinov2/pathmnist/myroot:extra=/a/n-nishida/mydinov2/pathmnist/myextra
    #print(train_dataset_str)
    ...
    Root location: /a/n-nishida/pathmnist/myroot
    StandardTransform
    Transform: Compose(
